// TASK-034 FR-021: Popup Search overlay.
// GQL search + parallel /trust enrichment for TI/ERV headline.
...
export function SearchOverlay({ onClose, isGuest, tier }: Props) {
  ...
  const doSearch = useCallback(async (q: string) => {
    ...
    try {
      // GQL search via background (gql.ts)
      ...
      // Enrich with trust data (parallel, max 5)

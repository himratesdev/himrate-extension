  ...
  return (
    <div className="sp-content" role="tabpanel">
      ...
      <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 10, padding: '12px 14px', background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
        <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: 6 }}>{t('trends.weekday.best_day')}</div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ fontSize: 24, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", color: 'var(--ink)', lineHeight: 1 }}>{t('trends.weekday.friday')}</div>
      ...
      <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 8, padding: '12px', background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
        <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 8 }}>{t('trends.weekday.ti_by_day')}</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        <div style={{ border: '2.5px solid var(--border-dark)', borderLeft: '4px solid #22C55E', borderRadius: 8, padding: '8px 10px', background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
          <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 4 }}>{t('trends.common.best')}</div>
        ...
        <div style={{ border: '2.5px solid var(--border-dark)', borderLeft: '4px solid #EF4444', borderRadius: 8, padding: '8px 10px', background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
          <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 4 }}>{t('trends.common.worst')}</div>

...
export function Frame34Trends7d({ onPeriodChange }: Props) {
  return (
    <div className="sp-content" role="tabpanel">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
        <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 8, padding: 10, background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)', cursor: 'pointer' }}>
          <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 6 }}>Реальные зрители</div>
        ...
        <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 8, padding: 10, background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)', cursor: 'pointer' }}>
          <div style={{ fontSize: 9, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 600, marginBottom: 6 }}>Рейтинг доверия</div>

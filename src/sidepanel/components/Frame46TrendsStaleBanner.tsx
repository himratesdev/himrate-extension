  ...
  return (
    <div className="sp-content" role="tabpanel">
      ...
      <div style={{ border: '2px solid #EAB308', borderRadius: 8, padding: '10px 12px', background: '#FFFBEB', display: 'flex', alignItems: 'flex-start', gap: 8 }}>
        ...
        <div>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#A16207' }}>Данные обновляются</div>
      ...
      <div style={{ opacity: 0.5, pointerEvents: 'none', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
        <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 8, padding: 10, background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
          <div style={{ fontSize: 10, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', fontWeight: 600 }}>Реальные зрители</div>
        ...
        <div style={{ border: '2.5px solid var(--border-dark)', borderRadius: 8, padding: 10, background: 'white', boxShadow: '2px 2px 0 rgba(0,0,0,0.15)' }}>
          <div style={{ fontSize: 10, color: 'var(--ink-50)', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', fontWeight: 600 }}>Рейтинг доверия</div>
